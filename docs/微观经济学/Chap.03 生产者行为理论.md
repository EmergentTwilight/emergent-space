...
tags: 
aliases: 
created: 2024-04-10T10:01:02
updated: 2024-06-24T02:50:06
---
# 企业与企业的本质
...
![Pasted image 20240424100736.png](Pasted-image-20240424100736.png)

### 总产量、平均产量和边际产量之间的关系

-  [微观04 1-企业的生产(1), page 13](微观04-1-企业的生产(1).pdf)
- 边际产量和平均产量
	- 边际产量大于平均产量时，平均产量会增加
	- 边际产量等于平均产量时，平均产量最大
...
-  [对于一个追求利润最大化的企业来说，生产要素的合理投入区为第二阶段](微观04-1-企业的生产(1).pdf)
- 即平均产量最大，到总产量最大
...
- [微观04 1-企业的生产(1), page 22](微观04-1-企业的生产(1).pdf)
- 两种投入，达到相同的某个产量的所有点对
- 性质
...
- $MRTS_{L,K}=-\frac{\Delta K}{\Delta L}|_{Q不变}$ *就是斜率的绝对值*
	- [微观04 1-企业的生产(1), page 29](微观04-1-企业的生产(1).pdf) 注意下标和比值的对应关系
- 边际技术替代率有**递减规律**
...
- 成本既定的情况下产量最大
	- **找到一条等产量线，与既定等成本线相切**[微观04 1-企业的生产(1), page 34](微观04-1-企业的生产(1).pdf)
	- 变化的视角
	...
	- 方程和最优解
		...
		- 成本之和为总成本
- 产量既定条件下的成本最小
	- **找到一条等成本线，与既定等产量曲线相切**[微观04 1-企业的生产(1), page 35](微观04-1-企业的生产(1).pdf)
- 关键方程
...
- 形状[微观04 1-企业的生产(1), page 41](微观04-1-企业的生产(1).pdf)
	- 资本多就是资本密集型
	- 劳动多就是劳动密集型
...
- ![Pasted image 20240424101651.png](Pasted-image-20240424101651.png)
	- 直线：投入比例不变
	- 100 到 200，规模收益递增
	- 200 到 300，规模收益不变
	- 300 到 400，规模收益递减
...
![Pasted image 20240424102550.png](Pasted-image-20240424102550.png)
...
- [微观04 2-企业的成本(1), page 4](微观04-2-企业的成本(1).pdf)
	- 第一题
		- 会计成本：30
		- 经济成本：30(1 + 5%) + 20 = 51.5
	- 第二题
...
- [微观04 2-企业的成本(1), page 5](微观04-2-企业的成本(1).pdf)
...
- MC 曲线**穿过了 ATC 和 AVC 曲线的最低点**![Pasted image 20240424112751.png](Pasted-image-20240424112751.png)
...
![Pasted image 20240424120259.png](Pasted-image-20240424120259.png)
...
- **规模经济**：生产要素**不一定**同比例增加
- $规模收益递增\subset 规模经济$，规模经济与规模收益递增不完全对应 [微观04 2-企业的成本(1), page 28](微观04-2-企业的成本(1).pdf)
	- 表中 2，既是规模经济，也是规模收益递增
	- 表中 3，是规模经济，但不是规模收益递增
- [微观04 2-企业的成本(1), page 29](微观04-2-企业的成本(1).pdf) 规模经济的扩展范围更广，但是规模收益递增*只能沿直线*
...
- 价格不变时![Pasted image 20240508102721.png](Pasted-image-20240508102721.png)
	- $AR=MR=\bar P$
	- $R=\bar P*Q$
- 价格递减![Pasted image 20240508102731.png](Pasted-image-20240508102731.png)
	- $AR=P(Q)$
