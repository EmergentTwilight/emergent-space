---
created: 2024-07-08T02:00:34
updated: 2024-07-11T09:58:51
---
# OpenMP

## Introduction

[7_HPC101-24_OpenMP.pdf](7_HPC101-24_OpenMP.pdf)
...
```c title="Hello OpenMP" hl_lines="2 5 7-9"
#include <omp.h>
#include <stdio.h>
int main() {
...
![Pasted image 20240708142548.png](Pasted-image-20240708142548.png)
...
![Pasted image 20240708142816.png](Pasted-image-20240708142816.png)
...
![Pasted image 20240708143009.png](Pasted-image-20240708143009.png)

```c title="Addition of two vectors" hl_lines="1"
...
只能使用等差数列形式的 for loop ![Pasted image 20240708144709.png](Pasted-image-20240708144709.png)

### Loop Schedule

```c title="Unbalanced workload"
#pragma omp parallel for
for(int i = 0; i < N; i++){
...
![Pasted image 20240708145730.png](Pasted-image-20240708145730.png)
...
![Pasted image 20240708154939.png](Pasted-image-20240708154939.png)
...
[7_HPC101_24_MPI.pdf](7_HPC101_24_MPI.pdf)
